...
export default function SignupComponents() {
  ...
  const handleSumbit = (e) => {
    ...
    let emailRegrex = /^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/
    let regex = /^(?=.*[A-Z])(?=.*\d).{8,}$/
    ...
    } else if (!emailRegrex.test(formValues.email)) {
  ...
  return (
    <div className=''>
      <div className='flex '>
        <div className='bg-primary w-1/2 max-h-full'>
          <img src={logo} className='max-w-[390px]  m-auto mt-[130px] mb-[112px]' />
        </div>
            ...
            <form class="space-y-1" onSubmit={handleSumbit}>
              <div>
                ...
                <div class="mt-2">
                  ...
                  <div className='text-red-500 '>{errors.username && errors.username}</div>
                </div>
              </div>
              <div>
              ...
              <div className=''>
                ...
                <div class="mt-2">
                  ...
                  {PasswordVisible ? (
                    <span class="material-symbols-outlined  cursor-pointer text-gray-500 text-xl" onClick={togglePassword}>
                      visibility
                    </span>
                  ) : (
                    <span class="material-symbols-outlined  cursor-pointer text-gray-500 text-xl" onClick={togglePassword}>
